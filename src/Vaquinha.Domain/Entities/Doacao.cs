...
namespace Vaquinha.Domain.Entities
{
    public class Doacao : Entity
    {
        ...
        public Doacao(Guid id, Guid dadosPessoaisId, Guid enderecoCobrancaId, double valor,
                      Pessoa dadosPessoais, CartaoCredito formaPagamento, Endereco enderecoCobranca, bool AceitaReceberEmail = false)
        {
            Id = id;
            ...
            AceitaReceberEmail = AceitaReceberEmail;
        ...
        public bool AceitaReceberEmail { get; private set;}
